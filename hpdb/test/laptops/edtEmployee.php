...
function getdata()
{
 ...
 <input type="hidden" name="edte" value="edte">
 <div>
...
<?php
    ...
    while ( $row = mysql_fetch_assoc($result) )
    {
		...
		echo "<td align=\"right\"><a href=\"delLaptop.php?id=$laptop_id&&edte=edte\"><img src=\"img/delim.png\" alt=\"Delete\" height=\"20\" width=\"20\"></a></td>";
		echo "</tr> ";
