...
/*
*/
function renderForm($id, $first_name, $middle_name, $last_name, $email, $gender, $project, $locations, $photo)
 {
 ?>
 <html>
 <head>
...
if (isset($_POST['submit']))
{
   ...
   $project       = mysql_real_escape_string(htmlspecialchars($_POST['project']));
       ...
       if ($first_name == '' || $email == '')
       {
           ...
           //error, display form
           renderForm( $id, $first_name, $middle_name, $last_name, $email, $gender, $project, $locations, $photo);
       }
       else
       {
		   // temp solution defolt photo
		   // todo add check if there is photo then insert real photo else add defolt one!
		   $photo = "000012.phg";
           // save the data to the database
           mysql_query("INSERT INTO employee VALUE(null, '$first_name', '$middle_name', '$last_name', '$email', '$photo', '$gender', '$project', '$locations')")
           or die(mysql_error());
