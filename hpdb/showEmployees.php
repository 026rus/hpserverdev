...
<td valign='middle'><a href="addEmployee.php"><font color='#ffffff'>add new employee</font></a></td></tr>
</table>
</header>
...
?>
    ...
    <td><input type="text" size="35" name="q_gender"        value="" /> </td>
    <td><input type="text" size="35" name="q_pname"         value="" /> </td>
